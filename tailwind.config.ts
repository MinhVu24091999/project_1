  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        bgTitleClipPath:
          "linear-gradient(90deg, #00225A 12.79%, #0D2A84 35.85%, #3A1D8E 64.78%, #FF4E36 100%)",
        bgTest:
          "linear-gradient(180deg, #181819 0%, #151515 25.48%, #1F1F1F 50%, #151515 76.44%, #181819 100%)",
      },
      keyframes: {
        fullBlock: {
          "0%": { transform: "translate(-20%, 100%) scale(0.7)", opacity: "0" },
          "50%": { transform: "translateY(0) scale(0.7)", opacity: "1" },
