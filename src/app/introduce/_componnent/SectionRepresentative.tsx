      ...
      <div className="relative">
        ...
        <div className="relative flex flex-col sm:flex-row gap-x-[70px] max-w-[1261px] mx-auto py-10 sm:py-[151px] px-4 sm:px-0 items-center sm:items-start gap-y-8">
          ...
          <div className="flex flex-col">
            <p
              className="sm:text-[40px] font-bold drop-shadow-[3px_3px_0px_0px_#000000;] mb-[13px] text-center sm:text-start text-3xl"
              style={{ lineHeight: "140%", textShadow: "3px 3px 0px #000000" }}
            >
              代表が担当する <br /> 唯一無二のサービス
            </p>

            <p className="sm:text-2xl mb-[30px]" style={{ lineHeight: "100%" }}>
              様々な状態の店舗オーナー様に向けて、幅広いサポートができます。
            </p>

            <p className="text-sm sm:text-lg" style={{ lineHeight: "200%" }}>
